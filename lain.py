...
#
    ...
    u=[1e0]*(7*n)
#
    res=differential_evolution(simu,args=(n,objs,c_l,c_a,c_v,0),callback=partial(conv,args=(n,objs,c_l,c_a,c_v)),bounds=list(zip(l,u)),workers=4,seed=1,polish=False,disp=True,maxiter=1000,updating='deferred')
#
    x0=res.x
